...
# Example to generate proportional order latency from feed latency
# https://hftbacktest.readthedocs.io/en/latest/tutorials/Order%20Latency%20Data.html
...
def generate_order_latency(feed_file, output_file = None, mul_entry = 1, offset_entry = 0, mul_resp = 1, offset_resp = 0):
    ...
    # Filter exchange and local events
    df = df.filter(
